...
class WikilinkTestCase(ParserTestCase):
    ...
    def test_files_removal(self):
        ...
        self.assertParsed(wikitext, ['[[Plik:Jan Matejko, Stańczyk.jpg|mały|lewo|Jan Matejko, Stańczyk]]'])
    ...
    def test_titled_link_without_ending_bracket(self):
        ...
        self.assertParsed(wikitext, ['some content and link.', '^ [http://example.com It should work by now'])
